...
public class PersonController {
        ...
        @RequestMapping(method = RequestMethod.GET, value= "firstName/{first}")
        public ResponseEntity<Collection<Person>> getFirstName(){
            return new ResponseEntity<>(repository.getFirstName(), HttpStatus.OK);
        }
